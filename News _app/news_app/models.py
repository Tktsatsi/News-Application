...
class CustomUser(AbstractUser):
    ...
    subscribed_newsletters = models.ManyToManyField(
    "Newsletter",
...
class Article(models.Model):
    ...
    def status(self):
        ...
        :returns: Status string for CSS classes - "rejected", "approved", or "pending"
        :rtype: str
        """
        if self.is_rejected:
            return "rejected"
...
class PublisherJoinRequest(models.Model):
    ...
    def __str__(self):
        ...
        :returns: Request details in format "username -> Publisher Name (status)"
        :rtype: str
        """
