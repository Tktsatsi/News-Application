...
router.register(r"newsletters",
                views.NewsletterViewSet, basename="api-newsletter")
router.register(r"publishers",
                views.PublisherViewSet, basename="api-publisher")
...
urlpatterns = [
    ...
    # Editor views
    path("pending/",
         views.PendingArticlesView.as_view(),
