...
def _build_tweet_text(article):
    ...
    Returns a string no longer than 280 characters.
    """
...
# The low-level Twitter posting logic is implemented in
# `news_app.utilities.twitter.post_to_twitter(message: str)`.
