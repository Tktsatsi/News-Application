...
urlpatterns = [
    ...
    path(
        ...
        views.web_subscribe_to_publisher,
        name="web_subscribe_to_publisher",
    ),
    path(
        "publishers/<int:publisher_id>/unsubscribe/",
        views.web_unsubscribe_from_publisher,
        name="web_unsubscribe_from_publisher",
    ),
    # Newsletter URLs
    ...
    path(
        "publishers/<int:publisher_id>/request-join/",
