...
from news_app.models import CustomUser, Publisher, Article, Newsletter, PublisherJoinRequest
...
class ReaderTests(TestCase):
    ...
    def test_reader_can_subscribe_to_publisher(self):
        """Test reader can subscribe to publishers."""
        response = self.client.get(
            reverse('web_subscribe_to_publisher', args=[self.publisher.id])
        )
    ...
    def test_reader_can_unsubscribe_from_publisher(self):
        ...
        # Then unsubscribe
        response = self.client.get(
            reverse('web_unsubscribe_from_publisher', args=[self.publisher.id])
        )
...
class JournalistTests(TestCase):
    ...
    def test_journalist_can_create_independent_article(self):
        ...
        # Check article was created
        self.assertTrue(Article.objects.filter(title='Independent Article').exists())
    ...
    def test_journalist_can_create_newsletter(self):
        ...
        self.assertTrue(Newsletter.objects.filter(title='Test Newsletter').exists())
    ...
    def test_journalist_cannot_subscribe_to_publishers(self):
        ...
        # Should get error message or redirect
...
class EditorTests(TestCase):
    ...
    def test_editor_can_approve_article(self):
        ...
        response = self.client.post(reverse('approve_article', args=[article.id]))
...
class IntegrationTests(TestCase):
    ...
    def test_complete_article_workflow(self):
        ...
        # Step 4: Reader subscribes to publisher
        response = self.client.get(
            reverse('web_subscribe_to_publisher', args=[self.publisher.id])
        )
        self.reader.refresh_from_db()
